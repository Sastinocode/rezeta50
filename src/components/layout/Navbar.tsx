    ...
    <header className="w-full bg-white border-b border-slate-100 px-4 py-3">
      <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2 flex-shrink-0">
          <span className="text-lg font-black text-[#1A3C5E] tracking-tight">Rezeta</span>
          <span
          ...
          {user ? (
            <>
              {isAdmin && (
                <Link
                  href="/admin"
                  className="flex items-center gap-1.5 text-xs sm:text-sm font-semibold px-3 py-1.5 rounded-lg text-[#1A3C5E] hover:bg-slate-100 transition-colors"
                >
